...
public class Webautomation {
	...
	@Test(priority = 1)
	  public void register() {
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Haritha\\Downloads\\chromedriver_win32 (1)/chromedriver.exe");
	      ...
	      wd.findElement(By.id("ap_customer_name")).sendKeys("HARI");
	      //wd.findElement(By.id("ap_phone_number")).sendKeys("1234567890");
	      wd.findElement(By.id("ap_email")).sendKeys("hari@gmail.com");
